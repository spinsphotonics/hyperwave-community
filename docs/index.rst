...
* **Three Workflows**: Local, inverse design, and API workflows
...
3. :doc:`workflows/inverse_design` - Gradient-based topology optimization with adjoint method
4. :doc:`workflows/api_workflow` - Single-call workflow for integration into existing systems
