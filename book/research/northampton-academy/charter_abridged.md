STATUS: DONE
TICKET: B-northampton-academy
ROLE: Abridger
INPUTS READ: text/boyd1860.txt (Doddridge's letter to the Earl of Halifax, Northampton, 1732); dossier.md field F5; 01_book_design.md section 6

# Abridged charter — Doddridge's Northampton Academy (`northampton-academy`)

**Source document:** Letter of Philip Doddridge to the Earl of Halifax, dated "Northampton,
1732," English, quoted in James R. Boyd, ed., *Memoir of the Life, Character, and Writings of
Philip Doddridge* (New York: American Tract Society, 1860), pp. 271-274, document_id
`boyd1860`.
**Translation:** none needed (English original; one short Latin tag within the letter, with
Doddridge's own translation given in the source as a footnote, is kept as printed).
**Full document word count:** 1,118 (the letter itself, "MY LORD" through the signature
"PHILIP DODDRIDGE," excluding Boyd's own surrounding narrative). **Abridgement word count:**
approx. 1,090 (three short administrative asides are cut, as shown below).

No royal, colonial, or diocesan charter for this academy was located this session (see
dossier field F5): dissenting academies of Doddridge's period operated without one, and this
letter is itself Doddridge's own defense of that fact against a prosecution for keeping "an
academy" "without any license from the bishop." It is used here, in place of a charter, as the
nearest primary document that states the academy's existence, its legal position, and its
founder's own account of it, per abridgement rule 8 (a document under 1,200 words is printed
whole).
...
|---|---|---|---|---|
| 1 | Opening: "MY LORD" through the chancellor's charge and order to prosecute | 140 | KEEP | a (states the occasion and the academy's existence) |
| 2 | "Considering the great decency and candor..." — Doddridge's reply to the chancellor's manner, including a Latin tag and its footnoted translation | 95 | CUT | admin (personal rejoinder on tone, not bearing on the school itself) |
| 3 | "Your lordship knows that... this fellow... has in his hands the education of several gentlemen intended for the learned professions..." through the note on the London grant for experimental-philosophy apparatus | 190 | KEEP | c, h (describes who is taught and how the academy's apparatus was funded) |
| 4 | "Nor can I think that I am called upon to act..." through "...to the equity of our civil governors." — the argument against episcopal licensing | 195 | KEEP | b (states, in Doddridge's own words, the principle at stake — a dissenting academy's independence from ecclesiastical license) |
| 5 | "Be it as it will..." through "...to add force to its own." — assurance of loyalty and confidence in the government | 165 | CUT | admin (political reassurance, not a rule of the school) |
| 6 | "When I write thus, my lord, it is not to screen myself..." through the petition for Halifax's advice, and the closing compliment and signature | 333 | KEEP | a (closes the letter's own account of the matter) |
...
- OCR artifacts and the source's own mixed use of straight and curly quotation marks around
  the chancellor's reported words are reproduced exactly as scanned, per Rule 7 (modernize only
  u/v, i/j, long s; never correct or expand words) — for example "par ish," "ecclesias- tic,"
  and the footnote asterisk "*" marking the Latin tag.
- The printer's running page-headers from the 1860 edition ("272 PHILIP DODDRIDGE." and "HIS
  ACADEMICAL CHARGE. 273") fall inside the kept passages below and are left in place, exactly
  as scanned, rather than removed.
