STATUS: DONE
TICKET: B-east-london-institute
ROLE: Abridger
INPUTS READ: text/wideworldourwork00guin.txt; dossier.md field F5; 01_book_design.md section 6

# Abridged charter -- East London Institute for Home and Foreign Missions (`east-london-institute`)

**Source document:** *The Wide World and Our Work in It: or, the Story of the East London Institute for Home and Foreign Missions*, 1886, English, London: Hodder and Stoughton, 1886, document_id `wideworldourwork00guin`, chiefly Chapter II ("Our Institute, and Why We Founded It," original pp. 23-37), with a small number of supplementary passages from elsewhere in the same book supplying material Chapter II itself does not contain (the admission practice described in Chapter III, pp. 58-59; the Tutor's Report and daily order printed later in the book as illustrative annual material, pp. 47-48 and 73-74; and the closing paragraphs on the Female Branch and on destinations, pp. 118-119 and 37).

**Why a book chapter, not a numbered charter:** No separately titled constitution, statute, or numbered "Principles and Practice" document (of the kind the China Inland Mission chapter uses) was located for this Institute in this session's search (see `sources.csv`, row `eli-prospectus-not-found`, and `scout_notes.md`). Its founders' own book-length institutional history is used instead as the founding document, per Rule 1 (never invent) rather than substituting a document that was not found.

**Translation:** none needed (English).

**Full document word count:** Chapter II alone runs approximately 5,730 words (source: `text/wideworldourwork00guin.txt`, lines corresponding to the chapter's start and the following chapter's start). The supplementary passages drawn from elsewhere in the same ~410-page book are not separately counted here; their combined length in this abridgement is under 500 words.
**Abridgement word count:** approximately 1,220 words (excluding `[...]` cut markers).

## Structure of the full document (Chapter II, in original order)

| # | Section / theme (no numbered articles in the original) | Approx. words | KEEP/CUT | Reason code |
|---|---|---|---|---|
| 1 | Opening: statement that the facts of Chapter I "led to the foundation, in 1872," of the Institute | ~40 | KEEP | a |
| 2 | Contact with willing but unplaced Christian young men (the crisis) | ~150 | KEEP (excerpt) | a |
| 3 | Critique of existing societies' preference for "scholarly gentlemen"; "army of officers only" | ~350 | KEEP (excerpt) | a |
| 4 | Scriptural analogy: tabernacle-builders of "all kinds," diversities of gifts | ~500 | KEEP (excerpt) | b |
| 5 | Practical difficulties considered: cost, support, "let such first be proved" | ~600 | CUT | admin |
| 6 | What a missionary should know (geography, astronomy, botany, medicine, etc.) | ~450 | CUT | admin (illustrative list, not a rule) |
| 7 | Decision against classics/mathematics, for general grounding | ~80 | KEEP | d |
| 8 | No denominational connections or support; dependence on God | ~250 | KEEP (excerpt) | h |
| 9 | Removal logistics: the £200 gift, finding a house at Stepney Green | ~300 | CUT | admin |
| 10 | The first hundred applicants; thirty-two selected, their denominations and nationalities | ~200 | KEEP | c |
| 11 | Household routine at Stepney Green in outline (study/evangelism split) | ~250 | CUT | repeat (fuller version kept from later chapters, item 15 below) |
| 12 | "Our First Twelve" missionaries and the fields inviting workers | ~450 | KEEP (excerpt) | g |
| *(supplementary, from Chapter III, pp. 58-59)* | Applications declined or received on probation; qualities sought (piety before learning) | ~200 | KEEP | c |
| *(supplementary, from pp. 47-48, Tutor's Report)* | Bible-classes, Theological Classes, Greek and Hebrew, general discipline and house-work | ~200 | KEEP (excerpt) | d, e |
| *(supplementary, from pp. 73-74, "Life at Cliff")* | Daily order: breakfast, household reading and prayer, study gong, evening study and prayers | ~250 | KEEP (excerpt) | e |
| *(supplementary, from pp. 118-119, "A Female Branch")* | Founding of Doric Lodge; rationale; destinations of its students | ~150 | KEEP (excerpt) | c |

Names of the "first twelve" missionaries, later students, and donors, and all descriptive/anecdotal material not bearing directly on purpose, admission, course of study, daily rule, or sending, are cut throughout, per Rule 6.3 (administrative detail, repeated formulae, and lists of names).

## Headnote

*The Wide World and Our Work in It: or, the Story of the East London Institute for Home and Foreign Missions*, by Mrs. H. Grattan Guinness, London: Hodder and Stoughton, 1886 (English; no translation needed); the copy digitized by the Internet Archive from a library holding is the edition used.
...
We did not think that it would be desirable to teach them classics and mathematics, but rather to ground them well in general knowledge, to sow in their minds the seeds of truth on many questions for future germination, to give them main outlines and fundamental prin- ciples rather than to crowd their memories with minor details.
...
Then at 6 o'clock in the evening, after tea, all will again be gathered in the classroom for quiet study, keeping steadily to their books until 9 o'clock, when the household assembles for evening prayers, gathering under the shadow of Jehovah's ever-sheltering, everlasting arms, to taste the blessedness of renewed confession, communion, and consecration at the throne of grace.
