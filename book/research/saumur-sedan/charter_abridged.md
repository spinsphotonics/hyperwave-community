STATUS: DONE (see coverage note)
TICKET: B-saumur-sedan
ROLE: Abridger
INPUTS READ: text/larhra-boisson-saumur.txt; dossier.md field F5; 01_book_design.md section 6

# Abridged charter — Saumur/Sedan (`saumur-sedan`)

**Coverage note.** No single founding charter document was located and read this session for
either academy. What follows is instead the fullest connected sequence, located this session, of
verbatim-quoted fragments of the actual royal and synodal texts that founded and governed both
academies — the 1593 letters patent for Saumur's college, the Edict of Nantes (1598), and the
successive National Synods' general regulations for the Reformed academies of France (Privas
1612, Tonneins 1614, Vitre 1617, and Ales 1620, whose "General Statutes for the Academies of the
Reformed Churches of France" applied equally to Sedan, Saumur, and every other Reformed academy)
— all quoted, with folio/page-level footnotes, in a single scholarly chapter on Saumur's college
and academy. This is quoted at second hand throughout, in the same manner Borgeaud (1900) was
used at second hand for `geneva-academy`. The narrative sentences connecting the quotations
(naming the synod, the year, the article number) are Boisson's own and are kept only where
needed to identify what is being quoted; cuts are marked `[...]`.

**Source document:** Didier Boisson, "Le college et l'academie de Saumur, un meme
etablissement?," in *Protestantisme et education dans la France moderne* (LARHRA, 2018), open
text sourced from https://books.openedition.org/larhra/3652. Language: French, with the quoted
fragments themselves being 16th-17th-century French legal and synodal prose. Edition: OpenEdition
Books open-access web edition. document_id `larhra-boisson-saumur`.
**Translation:** none in the original; a new working translation (English) is given after each
kept passage, marked `[New translation, draft]`.
**Full document (this chapter) word count:** approx. 6,000 (whole chapter). **Abridgement word
count (French text kept, excluding translations):** approx. 620.

## Structure of the full document (this session's excerpted range only; the chapter as a whole runs to 24 numbered paragraphs and is not outlined in full here)

| # | Passage (first words) | Words (approx.) | KEEP/CUT | Reason code |
|---|---|---|---|---|
| 1 | "[Founding acts, 1593-1685]" opening paragraph | 130 | KEEP | a (title/date/issuing authority) |
| 2 | "A Saumur, on peut distinguer quatre principales institutions..." | 60 | CUT | admin (institutional overview, not itself governing text) |
| 3 | "Malgre cette distinction... trois sources essentielles..." (methodology) | 90 | CUT | admin (historiographical method, not governing text) |
| 4 | "Le cadre institutionnel fixe... l'edit de Nantes... article XXII" | 55 | KEEP | b (doctrinal/legal basis: equal access) |
| 5 | "Mais aux articles dits particuliers..." (Edict of Nantes, restriction) | 55 | KEEP | b (legal basis, restriction clause) |
| 6 | "C'est donc essentiellement entre... Gap 1603... Ales 1620..." | 45 | CUT | admin (transitional narrative) |
| 7 | Synod of Privas 1612, article 12 (colleges vs. academies) | 40 | KEEP | c/h (institutional/financial rule) |
| 8 | Synod of Privas 1612, article 19 (four academies named) | 20 | KEEP | a (scope of the network) |
| 9 | Synod of Privas 1612, article 22 (councils to set their own rules) | 35 | KEEP | e (rule-making authority) |
| 10 | Synod of Privas 1612, article 20 (two theology professors) | 40 | KEEP | d (course of study/staffing) |
| 11 | Synod of Tonneins 1614, article 9 (funding) | 55 | KEEP | h (financial principle) |
| 12 | Synod of Vitre 1617 (statutes strictly observed; annual examination) | 40 | KEEP | g (examinations/oversight) |
| 13 | Synod of Ales 1620 (declines to alter the map of academies) | 65 | KEEP | a (scope, stability of the network) |
| 14 | "Les synodes provinciaux interviennent... Loudun" dispute | 100 | CUT | names/admin (a single local jurisdictional dispute) |
| 15 | "Une meme institution?" section through the Scevez hiring example | 140 | CUT | names/admin (illustrative anecdote, not governing text) |
| 16 | 24 July 1614 lodging rule (register quote) | 65 | KEEP | e (rules of daily life/residence) |
| 17 | Article I of the 1620 General Statutes (two councils) | 55 | KEEP | c/f (governance structure) |
| 18 | Articles II, III, V, X of the 1620 General Statutes (regents' oath; principal's authority; precedence) | 100 | KEEP | f (duties of teachers and their relation to students) |

## Headnote

Fragments of the royal and national-synodal texts that founded and governed the Academy of
Saumur and, through the 1620 General Statutes, every French Reformed academy including Sedan —
the 1593 letters patent, the Edict of Nantes (1598), and the National Synods of Privas (1612),
Tonneins (1614), Vitre (1617), and Ales (1620) — quoted at second hand, with Didier Boisson's own
connecting narrative retained where needed to identify each quotation, from his 2018 chapter "Le
college et l'academie de Saumur, un meme etablissement?"
...
1613, the keeping of a register "of the affairs of the academy," twenty years pass during which
the governor of Saumur fights for the opening of a full college and, from 1606, of an academy for
...
the first instance, the links between college and academy. Indeed, the Edict of Nantes contains
no article envisaging the creation of school establishments; only article XXII guarantees to the
Reformed "that no difference or distinction shall be made, on account of the said religion, in
...
[On the network of academies: National Synod of Privas, 1612.] Lors du synode de Privas de 1612 :
« Toutes les provinces auront des collèges, excepté celles qui ont des académies entretenues.
Néanmoins lesdites provinces, outre leurs académies, pourront établir des collèges à leurs propres
frais » (article 12 du chapitre sur les académies)
[New translation, draft: At the Synod of Privas in 1612: "All the provinces shall have colleges,
except those which have maintained academies. Nevertheless the said provinces may, in addition to
...
par an
[New translation, draft: At the Synod of Tonneins in 1614, article 9 of the chapter on academies
decides that the assembly grants the Academy of Saumur a subsidy for its operation, continuing
what had been allotted at previous synods, but adds that "to make its college more complete and
to furnish it with all the necessary regents and professors," the national synod grants a further
sum of 600 livres per year.]
...
[New translation, draft: The Synod of Vitre in 1617 recalls the necessity "in a very express
manner, to the academic councils, of ensuring that the academic statutes and regulations be
strictly observed." The provinces in which there is an academy must depute two pastors every year
to examine the students and see "whether the professors are doing their duty."]
...
However, "on the proposal made to regulate the number of academies, so as to furnish them fully
with professors, whether for theology or for the other sciences, it has not been found good to
make any decree for this now, given that a change on this matter might alter the good union which
must be preserved among us."]
...
classes, until he is lodged with the advice and consent of the rector, principal, or one of the
pastors, and they may not change lodging except with the aforesaid consent, which shall be made
...
[New translation, draft: the regents are "bound to swear to him and render obedience, in what
concerns both the manner of teaching and the discipline and punishment of the students" (article
II). "That the professors of philosophy be bound to follow his counsel and advice in what
concerns their charge," but also "he shall have inspection and oversight over the professors of
philosophy and over the exercises in their charge" (article III).]

« que tous les étudiants en philosophie soient tenus de luy jurer et rendre obéissance et pour
cest effect venir vers luy pour estre immatriculez » (article V).
[New translation, draft: "that all students in philosophy be bound to swear to him and render
obedience, and to this effect come before him to be enrolled" (article V).]

lors de tout acte solennel, le principal « marchera devant les professeurs en philosophie,
régentz, estudiantz en philosophie et escoliers classiques, comme chef de ce corps » (article X).
[New translation, draft: at every solemn ceremony, the principal "shall walk before the professors
