STATUS: DONE
TICKET: B-halle-francke
ROLE: Abridger
INPUTS READ: text/fenger1863-tranquebar.txt (Appendix I); dossier.md field F5; 01_book_design.md section 6
...
## Note on which document this is

This chapter covers two founding acts named in the roster: August Hermann Francke's charitable and educational foundations at Halle (begun 1694-95, on which see the `Founding` section of the chapter, drawing on Francke's own *Pietas Hallensis*) and the Danish-Halle Mission to Tranquebar (1706). The Danish-language and German-language documents that would most directly charter the Halle institutions themselves — Francke's *Ordnung und Lehrart* (school orders, 1702) and the *Hallesche Berichte* — could not be read this session (see `sources.csv`; German-language material is out of scope for this project per the task instructions). The one complete, clean, English-language primary founding document recovered and verified this session is the Danish king's Royal Declaration and Instruction commissioning Ziegenbalg and Plutschau — the actual charter of the "first Protestant overseas mission" named in the roster row, and the document dossier field F5 designates as this chapter's principal founding document. It is printed here whole, as the rules require for a document under 1,200 words.

## Structure of the full document

| # | Article / section heading (or first words) | Words | KEEP/CUT | Reason code |
|---|---|---|---|---|
| 1 | Title: "Royal Declaration and Instruction given by Frederick IV. to the first Missionaries" | 8 | KEEP | a |
| 2 | Royal Declaration (commission) to Ziegenbalg, "We, Frederick IV etc. ... Our greeting etc." | 130 | KEEP | a, b |
| 3 | Dateline and note that Plutschau received an identically-worded letter | 25 | KEEP | a |
| 4 | Heading "Instruction according to which..." and preamble naming Plutschau | 50 | KEEP | a |
| 5 | Article 1 (learn the native language from experienced men on the voyage) | 45 | KEEP | d |
| 6 | Article 2 (begin the work at once on arrival) | 45 | KEEP | c, e |
| 7 | Article 3 (use natural knowledge of God but rely on Scripture) | 65 | KEEP | b |
| 8 | Article 4 (doctrinal basis: hold to Scripture and the Augsburg Confession alone; preach repentance) | 60 | KEEP | b |
| 9 | Article 5 (instruct the ignorant in first principles with simplicity) | 30 | KEEP | d |
| 10 | Article 6 (be a pattern of good works) | 35 | KEEP | e |
| 11 | Article 7 (pray daily for the mission's success) | 60 | KEEP | e |
| 12 | Article 8 (keep friendship with local Evangelical pastors) | 25 | KEEP | e |
| 13 | Article 9 (financial principle: live on the royal salary, take no money from the people) | 35 | KEEP | h |
| 14 | Article 10 (report by every ship; may propose improvements) | 55 | KEEP | e, g |
| 15 | Article 11 (subscribe the Instruction in his own hand as a binding promise before God) | 35 | KEEP | g |
| 16 | Closing dateline, signature "Frederick R.", and note that Ziegenbalg received the same Instruction | 30 | KEEP | a |
| 17 | Translator's footnote on the order of the articles | 20 | KEEP | a (kept for transparency about the translation) |

No article was cut; the whole document is under the 1,200-word floor set in `01_book_design.md` section 6.8, so the rule there is "print it whole."
