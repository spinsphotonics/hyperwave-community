STATUS: DONE
TICKET: B-cmml-brethren
ROLE: Abridger
INPUTS READ: text/groves-christian-devotedness-1829.txt; dossier.md field F5; book/plan/01_book_design.md section 6

# Abridged charter — Christian Missions in Many Lands (`cmml-brethren`)

**Source document:** Anthony Norris Groves, *Christian Devotedness, or The Consideration of Our
Saviour's Precept, "Lay not up for yourselves treasures upon earth"*, 1st ed. 1825; text used
here is the 2nd ed. (London: James Nisbet, Berners Street, 1829), with Groves's own new preface
of 16 May 1829, document_id `groves-christian-devotedness-1829`.

**Translation:** none needed (English original).

**Full document word count:** 18,820 (excluding Project Gutenberg's own boilerplate header/footer;
counted from the title page through the end of the footnotes). **Abridgement word count:** 1,679
(body text below, excluding this header and the KEEP/CUT table; includes the six short bracketed
editorial headings).

**Note on genre.** This is not an institutional charter, statute, or constitution — CMML did not
exist until 1921, nearly a century after this tract was written. It is included, per the roster
and ticket instructions, as the doctrinal-financial founding text of the Brethren faith-missions
principle that CMML's commendation system still runs on (see dossier F5-F6, M2). Because the
document is a continuous theological argument rather than a statute with articles, the "KEEP"
priorities below map onto book design section 6.2's categories (b) doctrinal basis and (h)
financial principle where it is doctrinal, rather than (c)-(g), which do not apply to a text with
no admissions process, course of study, or examinations of its own.

## Structure of the full document (two-pass outline, per section 6.8 — document exceeds 15,000 words)

| # | Section | Words | KEEP/CUT | Reason code |
|---|---|---|---|---|
| 1 | Title page and Gutenberg front matter | 192 | CUT (partial; title/author/date KEPT) | admin |
| 2 | Preface (new, 1829) | 977 | KEEP (partial) | b, h |
| 3 | Section I: the Scriptural account of the Principle (Matt. 6, the rich young man, the poor widow, Acts 2 & 4 community of goods, 2 Cor. 8) | 3,847 | KEEP (partial) | b, h |
| 4 | Section II: bearing of the Principle on other commands (the Great Commission, "Love thy neighbour", diversities of gifts) | 2,397 | KEEP (partial) | b, g |
| 5 | Section III: arguments from reason (children's provision, Abraham, the sabbatical year, definition of "giving up all", closing exhortation) | 4,780 | KEEP (partial) | b, h |
| 6 | Appendix (on 1 Tim. 5:8 and 2 Cor. 12:14, objections answered) | 1,285 | CUT | repeat (answers objections already stated in the Preface) |
| 7 | Footnotes (including Scott, Hammond, Whitby, Cecil quotations, and the note on adopting an orphan daughter in 1842) | 5,342 | CUT | admin/repeat (supporting citations and later biographical footnote, not the founding argument itself) |

## Selection within the KEPT sections (reason code per passage)

| # | Passage (first words) | Words | Reason |
|---|---|---|---|
| 1 | "In sending a second impression of the following little work..." | 211 | a — preamble, states the author revised his own practice |
| 2 | "The principal objections urged, seem to arrange themselves..." | 102 | b, h — doctrinal-financial thesis stated against objections |
| 3 | "With regard to the other two points... That the principle of God's government is paternal..." | 88 | b — doctrinal ground of the faith principle |
| 4 | "The writer of the following pages has been deeply affected..." | 146 | a — statement of the crisis/purpose |
| 5 | "This manifestation of love he believes to have been made by the entire and real... devotion..." | 31 | b — the tract's single thesis sentence |
| 6 | "When the young man came to enquire what good thing..." (rich young man / camel) | 112 | b — core Scriptural argument |
| 7 | "The conduct of them and their adherents is thus recorded by St. Luke (Acts 2.44... Acts 4.32...)" | 161 | b — primitive-church precedent argued from |
| 8 | "'Go ye into all the world and preach the gospel to every creature'... was the parting command..." | 81 | g — the sending clause equivalent |
| 9 | "It is not meant absolutely to say that every man should become a Missionary..." | 108 | g — distinguishes goers from senders (Brethren "sending" logic) |
| 10 | "Let us therefore 'endure hardness, as good soldiers of Jesus Christ'..." | 42 | h — cost of the faith principle |
| 11 | "Should I be asked, what I understand by giving up all for Christ..." | 332 | b — Groves's own operative definition |
| 12 | "Thus I leave the question to those who love the Lord Jesus Christ in sincerity..." | 181 | a — closing exhortation |

## Headnote

*Christian Devotedness, or The Consideration of Our Saviour's Precept, "Lay not up for yourselves
treasures upon earth,"* by Anthony Norris Groves (1795-1853); 1st edition London, 1825; text
abridged here from the 2nd edition (London: James Nisbet, 1829), in the original English, no
...
Gospel History, [...] that primitive Christianity owed much of its
...
property, time and talents to Christ, their Lord and King.
...
they be sent?", still is the order of God's government.
...
vocation, and by rigid habits of self-denial.

[...]

Let us therefore "endure hardness, as good soldiers of Jesus
