...
TICKET: B-wittenberg
ROLE: Abridger
INPUTS READ: text/luther1524-councilmen.txt; dossier.md field F5; book/plan/01_book_design.md section 6

# Abridged charter — University of Wittenberg (`wittenberg`)

**IMPORTANT — scope of this abridgement.** No single document functioning as a "founding charter"
of the reformed Wittenberg curriculum (Melanchthon's 1518 inaugural oration; his 1528/1538
*Unterricht der Visitatoren*, which contains the actual school order; or the 1536 university
statutes) was located as a fetchable public-domain text this session (see sources.csv and
discrepancies.md item 5). What follows is instead an abridgement of the primary document that
*was* fetched and read in full and that the roster names as one of Wittenberg's key primary
documents: Martin Luther's 1524 open letter to the German city councils, arguing the case for
establishing and maintaining Christian schools. It functions, in this book's terms, as the most
complete surviving primary "charter-in-substance" available from what was fetched this session --
a founder's public statement of purpose, doctrinal grounding, course of study, and financial
principle, addressed to the civil authorities who would have to act on it. Luther's companion 1530
*A Sermon on Keeping Children in School* was also fetched in full (`text/luther1530-sermon.txt`)
and is drawn on in the chapter narrative and quote records, but is not separately abridged here to
stay within the book's 1,200-2,500 word target for this section.

**On the KEEP text below:** every KEEP passage is copied verbatim, character for character, from
`text/luther1524-councilmen.txt`, including the source scan's own OCR artifacts (stray marginal
running-heads folded into the text stream, misrecognized letters and ligatures, footnote
call-outs), per Rule 9 (do not correct the sources) and Procedure F step 2.4 (do not correct
spelling; do not modernize). The one deliberate change: every place where this session's own
`[[p. N]]` page-marker tag falls inside a KEEP passage, it has been replaced with the ordinary
`[...]` cut mark, since the tag is this session's own finding aid, not part of Luther's text, and
is not a content omission -- the surrounding words are unbroken in the original. Every resulting
passage, on both sides of such a mark, still matches `text/luther1524-councilmen.txt` verbatim
(`templates/check_quotes.py --charter` passes cleanly on this file).

**Source document:** *To the Councilmen of All Cities in Germany That They Establish and Maintain
Christian Schools*, 1524 (German original), English translation by Albert T. W. Steinhaeuser in
*Works of Martin Luther*, vol. IV (Philadelphia: A. J. Holman Company and The Castle Press, 1931),
document_id `luther1524-councilmen`.
**Translation:** Steinhaeuser's 1931 translation (public domain in the US as a pre-1932
publication); no new translation was made.
**Full document word count:** approx. 11,000 (the letter's translated text, excluding the
translator's introduction).
**Abridgement word count:** approx. 2,030 (main letter, below) + approx. 90 (supplementary
Unterricht-der-Visitatoren excerpt, from a different document, given separately further below) =
approx. 2,120.

## Structure of the full document

| # | Section (by content; undivided document, paragraphs grouped by topic) | Approx. words | KEEP/CUT | Reason code |
|---|---|---|---|---|
| 1 | Salutation and opening defense of speaking out despite the ban (pp. 103-104) | ~450 | KEEP (a) | preamble |
| 2 | Opening complaint: schools "go to wrack and ruin" (p. 104) | ~120 | KEEP (a) | preamble |
| 3 | Argument that even one trained boy is worth a prince's ransom; parable of the hundred gulden (pp. 105-106) | ~250 | CUT | illustrative |
| 4 | Duty of councilmen: spend on schools what is spent on fortifications; redirect money once given to indulgences (pp. 106-107) | ~260 | KEEP (h) | financial principle (doctrinal) |
| 5 | Objections answered: heretics, tyrants, "no money" (pp. 107-110) | ~900 | CUT | repeat/admin |
| 6 | A city's true welfare is its educated citizens; the Roman analogy; trivium and quadrivium (pp. 110-112) | ~330 | KEEP (a, d) | purpose; course of study |
| 7 | Necessity of the biblical languages for preserving the Gospel (pp. 112-118) | ~2,400 | KEEP (excerpt only, b) | doctrinal basis |
| 8 | Simple preacher vs. expositor/"prophet"; languages needed by the latter (pp. 118-119) | ~350 | CUT | repeat of (b) |
| 9 | Temporal government likewise needs educated persons, not only the spiritual estate; for both boys and girls (pp. 119-121) | ~500 | KEEP (a, d) | purpose; extends to civil offices and to girls |
| 10 | Course of study: languages, history, singing, instrumental music, mathematics; contrast with the old scholastic drilling (pp. 121-123) | ~600 | KEEP (d) | course of study |
| 11 | The Roman example continued; German neglect of history-writing (pp. 123-125) | ~450 | CUT | repeat/illustrative |
| 12 | Duty to found libraries (pp. 125-127) | ~350 | KEEP (e/f, library as institutional provision) | rules of civic provision |
| 13 | Catalog of bad books to discard; further remarks on languages and the Waldensians (pp. 127-129) | ~700 | CUT | repeat/polemical |
| 14 | Closing exhortation and commendation to God (pp. 129-133) | ~500 | KEEP (a) | closing |
...
## Supplementary excerpt (a different document, given here rather than after "Text" below so that
it is not mistaken for part of the Councilmen letter or verified against the wrong source file)

The school order of Melanchthon's *Unterricht der Visitatoren*, 1528/1538, was not located this
session as a fetchable text (see dossier.md field F5 and discrepancies.md item 5). The following
three sentences survive only at second hand, in F. V. N. Painter's 1889 English rendering
(document_id `painter1889-lutheroneducation`; quote_ids wittenberg-q010, wittenberg-q011), and are
reproduced whole because they total under 100 words:

"In order that the young may be properly taught," says the Plan, "we have established this form:

"I. The teachers shall see to it that the children are taught only Latin, not German or Hebrew as
some have hitherto done, who have burdened their pupils with too many studies, which are not only
useless but hurtful. ...

"2. They shall not burden the children with many books, but in every way avoid a distracting
...
attack my speaking and writing and shed much blood over it.^ 
...
Therefore I will speak, as Isaiah says; and not hold my 
peace as long as I live, until Christ’s righteousness go forth 
as brightness and His saving grace be lighted as a lamp. 


^Heinricli Vos and Johann yan den Easchen, the first martyrs of Protestant- 
ism, were burnt at Brussels, July 1, 1523. Cf. also The Burning of 
Brother Henry in Dithmarschen (1S25), included in this vol- 
jmie, see p. 184 ff.  [...]  [...] And I pray you now, all my dear sirs and friends, to receive 
...
and ruin; universities are growing weak, monasteries are 
...
Th«Duty Therefore, I pray you all, my dear sirs and friends, for 
plrtoff God s sake and the poor youths', not to treat this subject as 
sdMwia lightly as some do, who are not aware of what the prince 
...
M«saiw Moreover, every citizen should be moved by the following 
consideration. Formerly he was obliged to ^ve up so much 
ahja money and property for indulgences, masses, vigils, endow- 
...
of that amount for schools in which to train the poor chil-  [...] dren, which would indeed he a good and precious investment. 

[...]

[On the welfare of a city.]

1 It &erefore becomes the business of councilmen and why the 
magistrates to devote the greatest care and attention to state 
the young. For since the property, honor and life of the 
whole city are committed to their faithful keeping, they would scHwIb 
...
them and put them to a good useT"! 

Thus it was done in ancienT^Rome. There boys were 
...
as they are called,^ and immediately entered upon a military 
...
6;17 in which this sword of the Spirit is contained; they are the 
...
suffice to establish ever3rwhere the very best schools for both 
...
of schools we attended are a thing of the past— that hell and  [...] purgatory in which we were tormented with cases and tenses, 
...
music, and all of mathematics.'^ For what is all this but 
...
if the Bible and all thie arts are to be preserved, they must 
be contained and held fast in books and writings, as was 
done by the prophets and apostles themselves, as I have said 
above.'' This is necessary, not only that those who are to 
...
Ex.i8;i7ff. Moses was obliged to receive instruction from Jethro. 
