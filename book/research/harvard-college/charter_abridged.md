...
|---|---|---|---|---|
| 1 | Preamble: "1. After God had carried us safe to New-England..." through "...called...Harvard Colledge." | 183 | KEEP | a (title/date/issuing occasion/preamble) |
...
| 3a | "Over the Colledge is master Dunster placed..." through "...principles of Divinity and Christianity," | 37 | KEEP | a (names the President, ties to F3/T1) |
...
| 6 | "3. The times and order of their Studies..." (weekly schedule) plus the two closing Degree paragraphs | 470 | KEEP | d, g (course of study; examinations/degrees) |
...
- Three bracketed insertions that belong to the 1938 editors themselves (not to this book's
  Abridger) appear in the schedule: a clarifying "[with]" before the names Nonnus and Duport; a
  gloss "[i.e. Aramaic]" after "Chaldee"; and a single letter "[i]" completing "Dan[i]el." Because
  this book's own abridgement convention also uses square brackets for editorial insertions, these
  three (and only these three) are rendered above with angle brackets — ⟨with⟩, ⟨1.e. Aramaic⟩,
  Dan⟨i⟩el — solely so they are not mistaken for a cut or an insertion made by this book's
  Abridger. No word has been added, removed, or changed; text/nef1643.txt (the file of record)
  preserves the original square brackets exactly as scanned.
