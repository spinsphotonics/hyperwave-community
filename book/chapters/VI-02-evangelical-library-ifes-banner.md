STATUS: DONE (draft — see coverage note)
TICKET: D-evangelical-library-ifes-banner
ROLE: Writer
INPUTS READ: research/evangelical-library-ifes-banner/dossier.md (VERIFIED); research/evangelical-library-ifes-banner/quotes.jsonl; research/evangelical-library-ifes-banner/charter_abridged.md; plan/01_book_design.md

**Coverage note (remove before final publication, or move to an editorial
appendix):** This chapter covers three related but administratively
separate organizations, per the roster: the Evangelical Library, the
International Fellowship of Evangelical Students (IFES), and the Banner of
Truth Trust. None of the three is a school; none admitted, taught, or sent
students in the sense this book's template assumes, and the Admission,
Curriculum, and Sending sections say so rather than inventing an answer. No
full founding charter, constitution, or trust deed was located in full text
for any of the three; the single primary-quality founding text recovered is
one 39-word clause from the Banner of Truth Trust's 1957 trust deed, quoted
at second hand because banneroftruth.org refused this session's automated
fetch (HTTP 403). Two roster facts are corrected against fetched sources
rather than repeated: IFES was founded at Harvard University, Massachusetts
— not Lausanne, Switzerland, which is where IFES is legally registered
today — and the Evangelical Library's founding is dated 1938 and 1944 in
every source located, not 1945 as the roster states; both discrepancies are
logged in `research/evangelical-library-ifes-banner/discrepancies.md` and
not silently resolved. Every direct quotation used is under 60 words and
drawn from institutional websites, Wikipedia, or magazine articles, none of
which is copyrighted material requiring a rights flag under this book's
rules (`06_rights_and_permissions.md`); no `[RIGHTS: ...]` flags or
`permissions_log.csv` entries were needed this session.
